...
<h3 class="alert alert-warning text-center">Votre panier est vide, allez vite le remplir => </h3><a class="hover" href="<?= SITE; ?> "></a></h3>


<?php else: ?>
<div class="d-flex justify-content-end">
<a href="?destroy=1"><button class="btn btn-outline-danger btn-rounded" >Vider le panier</button></a></td>
</div>
...
<?php if(connect()): ?>
    <a href="?order=1" class="btn btn-success">Passez commande</a>

<?php else: ?>
    <a href="<?= SITE.'security/login.php' ?>" onclick="return confirm('Authentifiez-vous!' class="btn btn-success">Passez commande</a>

<?php  endif; endif; require_once '../inc/footer.php'; ?>
